...
const SW_VERSION = "2026-09-24-09";
...
self.addEventListener('install', function(e) {
  ...
  e.waitUntil(caches.open(CACHE).then(function(c) {
    var core = ['./', './data.js', './scoring.js?v=2026-09-24-3', './lab/engine.js', './manifest.json', './icon-192-v2.png', './sounds/eagle-1.mp3', './sounds/eagle-2.mp3'];

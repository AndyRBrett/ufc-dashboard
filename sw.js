...
const SW_VERSION = '2026-09-13-01';
...
self.addEventListener('fetch', function(e) {
  ...
  var path = isNavigate ? '' : new URL(req.url).pathname;
  ...
  if (isNavigate || isData || isIntel) {
    var cacheKey = isNavigate ? './' : (isIntel ? './intel.json' : './data.js');
    e.respondWith(

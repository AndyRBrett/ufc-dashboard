...
const SW_VERSION = "2026-09-24-04";
...
self.addEventListener('install', function(e) {
  ...
  e.waitUntil(caches.open(CACHE).then(function(c) {
    var core = ['./', './data.js', './lab/engine.js', './manifest.json', './icon-192-v2.png', './sounds/eagle-1.mp3', './sounds/eagle-2.mp3'];
...
self.addEventListener('fetch', function(e) {
  ...
  if (isNavigate || isData || isIntel || labKey) {
    ...
    var cacheKey = isLabNav ? './lab.html' : isNavigate ? './' : labKey || (isIntel ? './intel.json' : './data.js');
    e.respondWith(
